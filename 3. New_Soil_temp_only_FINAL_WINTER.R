...
fit_space <- stan(file = 'scripts/users/hthomas/Tea/soiltemp_loss_3.stan', data = jags.dat, init=inits, iter = 500, chains = 2, thin = 1, verbose = TRUE, control=list(adapt_delta=0.99,max_treedepth = 10), algorithm = "NUTS") 
