...
save(predsout.space, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_moisture_preds_tea_int_scaled_year.Rdata")
save(cout, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_moisture_fits_tea_int_scaled_year.Rdata")
