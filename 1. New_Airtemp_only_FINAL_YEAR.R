...
save(predsout.space, file = "scripts/users/hthomas/Tea/Stan_outputs/airtemp_preds_year.Rdata")
save(cout, file = "scripts/users/hthomas/Tea/Stan_outputs/airtemp_fits_year.Rdata")

pdf("scripts/users/hthomas/Output_Images/Tea/airtemp_only_year.pdf", width = 3, height = 3)
ggplot()+
...
save(airtemp_only_year, file = "scripts/users/hthomas/Tea/airtemp_only_year.Rdata")
