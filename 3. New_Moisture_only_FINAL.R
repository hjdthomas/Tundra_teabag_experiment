...
save(predsout.space, file = "scripts/users/hthomas/Tea/Stan_outputs/moisture_preds_summer.Rdata")
save(cout, file = "scripts/users/hthomas/Tea/Stan_outputs/moisture_fits_summer.Rdata")

pdf("scripts/users/hthomas/Output_Images/Tea/moisture_med_summer.pdf", width = 3, height = 3)
ggplot()+
...
save(moisture_only_summer, file = "scripts/users/hthomas/Tea/moisture_only_summer.Rdata")
