...
save(predsout.space, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_preds_summer.Rdata")
save(cout, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_fits_summer.Rdata")

pdf("scripts/users/hthomas/Output_Images/Tea/soiltemp_med_summer.pdf", width = 3, height = 3)
ggplot()+
...
save(soiltemp_only_summer, file = "scripts/users/hthomas/Tea/soiltemp_only_summer.Rdata")
