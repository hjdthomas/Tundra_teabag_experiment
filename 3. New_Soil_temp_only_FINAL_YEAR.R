...
save(predsout.space, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_preds_year.Rdata")
save(cout, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_fits_year.Rdata")

pdf("scripts/users/hthomas/Output_Images/Tea/soiltemp_med_year.pdf", width = 3, height = 3)
ggplot()+
...
save(soiltemp_only_year, file = "scripts/users/hthomas/Tea/soiltemp_only_year.Rdata")
