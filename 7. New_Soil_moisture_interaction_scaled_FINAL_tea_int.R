...
save(predsout.space, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_moisture_preds_int_scaled.Rdata")
save(cout, file = "scripts/users/hthomas/Tea/Stan_outputs/soiltemp_moisture_fits_int_scaled.Rdata")
